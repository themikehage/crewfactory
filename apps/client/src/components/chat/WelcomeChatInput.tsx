    ...
    <div className="w-full max-w-3xl mx-auto flex flex-col items-center justify-center px-4 py-8 animate-fade-in">
      ...
      >
        ...
        <div className="flex items-center justify-between mt-3 pt-2 border-t border-border/30">
          ...
          <div className="flex items-center gap-2">
            {/* Mock Audio Waveforms */}
            <button
              type="button"
              title={l.voiceInputMock}
              className="p-2 hover:bg-surface-hover text-text-secondary/50 hover:text-text-secondary rounded-lg transition-colors cursor-pointer"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  strokeLinecap="round"
            ...
            <button
              type="button"
              title={l.voiceInputMock}
              className="p-2 hover:bg-surface-hover text-text-secondary/50 hover:text-text-secondary rounded-lg transition-colors cursor-pointer mr-1"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="2"
                  d="M5 12h14M12 5v14M8 8h8M8 16h8"
                />
              </svg>
            </button>
