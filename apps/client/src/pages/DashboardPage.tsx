...
export function DashboardPage({ onNavigate, onSelectProject }: Props) {
  ...
  const activeSessions = useMemo(() => {
    return sessions
      ...
      .slice(0, 6); // Spotify uses 6 items in mobile top section
  }, [sessions]);
  ...
  return (
    <div className="h-full flex flex-col bg-bg overflow-y-auto pb-10 scrollbar-thin">
      {/* Mobile Top Header (Estilo Spotify con Avatar de usuario y Filtros en píldoras) */}
      <div className="bg-linear-to-b from-primary/10 via-bg to-bg px-5 pt-6 pb-4 sm:pt-10 sm:pb-8 border-b border-input/5">
        <div className="max-w-6xl mx-auto space-y-4">
          ...
          {/* Filtros Píldora horizontales estilo Spotify */}
      ...
      <div className="max-w-6xl mx-auto px-5 py-6 w-full space-y-9">
        ...
        {loading ? (
          ...
          <>
            {/* Seccion 1: Sesiones Recientes ("Las mejores selecciones para ti" - Grilla compacta de 2 columnas) */}
              ...
              <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
                {activeSessions.map((session) => {
                  ...
                  return (
                    ...
                    >
                      {/* Portada izquierda de la sesión (Spotify style) */}
            ...
            {/* Seccion 2: Proyectos (Carrusel horizontal con Snap) */}
            <div id="projects-sec" className="space-y-3">
              ...
              <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-3 -mx-5 px-5 scrollbar-none sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                {repos.map((repo) => (
                  ...
                  >
                    <div>
                      {/* Portada grande y cuadrada del Proyecto */}
            ...
            {/* Seccion 3: Canales (Carrusel horizontal con Snap) */}
            <div id="channels-sec" className="space-y-3">
              ...
              <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-3 -mx-5 px-5 scrollbar-none sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                {channels.map((channel) => (
                  ...
                  >
                    <div>
                      {/* Portada grande y cuadrada del Canal */}
                      <div className="w-full aspect-square relative rounded-xl overflow-hidden bg-surface-hover shadow-sm group">
                        <EntityAvatar
                          name={channel.name}
            ...
            {/* Seccion 4: Agentes (Avatares redondos grandes en carrusel horizontal) */}
      ...
      {/* MODAL: Info / Detalles del Proyecto */}
      <AnimatePresence>
        {infoProject && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-xs flex items-center justify-center z-50 p-4">
            <motion.div
