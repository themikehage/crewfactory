...
export const literals: Record<SupportedLocale, Record<string, string>> = {
  en: {
    ...
    pageTitle: "Teams",
    pageSubtitle: "Multi-agent stateless teams for negotiation and conflict resolution",
    refresh: "Refresh",
    emptyTitle: "No teams created",
    emptyDescription: "Create a team to bring multiple agents together in debate",
  ...
  es: {
    ...
    pageTitle: "Equipos (Teams)",
    pageSubtitle: "Equipos multi-agente stateless para negociación y resolución de conflictos",
    refresh: "Actualizar",
    emptyTitle: "No hay equipos creados",
    emptyDescription: "Crea un equipo para reunir múltiples agentes en debate",
