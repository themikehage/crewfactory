...
import { literals as projectsLiterals } from "./ProjectsPage.literals";
...
export function ProjectsPage({ onSelectProject }: Props) {
  const l = useLiterals(projectsLiterals);
        ...
        <div className="max-w-4xl mx-auto p-3 sm:p-6 space-y-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
            <div>
              ...
              <p className="text-muted-foreground text-[11px] mt-0.5 font-body">
                {l.subtitle}
              </p>
            </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground mt-1 font-body">
                      {l.lastModified} {new Date(repo.lastModified).toLocaleString()}
                    </p>
                  </div>
                  <div className="flex items-center gap-2 mt-4">
                    <button
                      onClick={() => onSelectProject(repo.id || repo.name, repo.name)}
                      className="flex-1 py-1.5 bg-card-hover/20 hover:bg-primary hover:text-background text-foreground border border-input/30 rounded-lg text-xs font-semibold transition-all cursor-pointer flex items-center justify-center gap-1.5"
                    >
                      {l.open}
              ...
              <form onSubmit={handleUpdateInfo} className="space-y-4">
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <div className="flex-1">
                    <label className="block text-xs font-semibold text-muted-foreground uppercase tracking-wider mb-1 font-body">
                      {l.projectNameLabel}
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-3 py-1.5 bg-background border border-input rounded-lg text-sm text-foreground focus:outline-none focus:border-primary"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-card-hover/20 border border-input rounded-lg text-sm text-muted-foreground focus:outline-none font-body"
                  />
                </div>
