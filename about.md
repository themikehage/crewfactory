...
- **Bypass Silencioso Pre-LLM:** Los agentes inactivos o no-mencionados (y observers) evitan realizar llamadas innecesarias al LLM en canales multi-agente, ahorrando hasta un 55% en coste de inferencia.
