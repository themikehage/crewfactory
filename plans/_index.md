...
- [channel-execution-protocol.md](./channel-execution-protocol.md) — Protocolo durable: ejecuciones y turnos ordenados, eventos secuenciados, ciclo de vida unificado de tools y recuperación tras reconexión.
