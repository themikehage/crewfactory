...
- [hackathon-agent-society-roadmap.md](./hackathon-agent-society-roadmap.md) — Hoja de ruta Track 3 "Agent Society": análisis competitivo (CrewAI/LangGraph/MetaGPT/ChatDev), gaps frente a los 3 requisitos obligatorios, y 6 fases detalladas (negotiation engine, benchmark harness, role decomposition, MCP, optimization loop, submission assets) para elevar CrewFactory a submission ganadora.
